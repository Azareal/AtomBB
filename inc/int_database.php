...
interface int_database
{
	...
	public function __invoke($query, $critical = false);
	...
	public function update($table, $update, $where = null, $critical = false);
	public function diff_update($table, $update, $where = null, $current = false);
	public function bulk_update($table, $update, $critical = true);
