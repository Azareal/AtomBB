<?php
/*
	AtomBB Admin Usergroup List Language File
	Created by Azareal.
...
$l['groups_success_new'] = "The requested group has successfully been created.";
$l['groups_success_edit'] = "The requested group has successfully been updated.";

$l['groups_head'] = "Group List";
$l['groups_edit'] = "Edit";
$l['groups_delete'] = "Delete";
$l['groups_submit'] = "Submit";
$l['groups_none'] = "There are currently no groups.";