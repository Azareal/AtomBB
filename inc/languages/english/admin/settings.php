<?php
/*
	AtomBB Admin Setting List Language File
	Created by Azareal.
...
$l['settings_success_edit'] = "You have successfully edited the settings.";
...
$l['settings_setting_avatar_widthmax'] = "Maximum allowed Avatar Width";
...
$l['settings_setting_level_switch_desc'] = "The setting which determines whether the activty level system is enabled.";
$l['settings_setting_show_post_upvoters'] = "Show the people who enjoy a specific post";
$l['settings_setting_show_post_upvoters_desc'] = "The setting which determines whether the people who upvoted a post will be listed";
$l['settings_setting_minimum_post_length'] = "Minimum Post Length";
$l['settings_setting_minimum_post_length_desc'] = "The setting which determines the minimum length which a post must be.";
$l['settings_setting_post_word_minimum'] = "Minimum Word Count";
$l['settings_setting_post_word_minimum_desc'] = "The setting which determines the minimum number of words which a post is allowed to have.";
$l['settings_setting_url_check_internal_links'] = "Check for broken links";
$l['settings_setting_url_check_internal_links_desc'] = "Whether to check for broken links in user posts. This setting may be circumvented by caching.";
$l['settings_setting_announce_show_on_all'] = "Show the opening post on all pages for announcement topics";
$l['settings_setting_announce_show_on_all_desc'] = "The setting which determines whether the opening post will be shown at the top of every page in the announcement topics.";
...
$l['settings_setting_warnings_notice_minimum_points'] = "Minimum warning points to trigger notice";
$l['settings_setting_warnings_notice_minimum_points_desc'] = "The setting which determines the number of warning points which a user needs before a notice starts warning them about their high number of warning points.";
...
$l['settings_setting_about_page'] = "About Page";
$l['settings_setting_about_page_desc'] = "The custom page which explains what your site is all about.";
$l['settings_setting_enable_title_page'] = "Enable Title Pages";
$l['settings_setting_enable_title_page_desc'] = "The setting which controls whether users can access the pages which explain the titles to them.";
...
$l['settings_group_posts'] = "Message Settings";
$l['settings_group_posts_desc'] = "This setting group holds the settings relating to the posts and discussions.";

$l['settings_none'] = "There are currently no settings in this group.";

$l['side_nav_head'] = "Settings";
$l['side_nav_general'] = "General Settings";